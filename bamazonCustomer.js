...
var connection = mysql.createConnection({
  ...
  port: 3306,
  user: "root",
  password: "",//removed password for privacy//
  database: "bamazon_db"
})
...
connection.query('SELECT * FROM Products', function(err, res){
  ...
  for(var i = 0; i<res.length;i++){
    console.log("ID: " + res[i].ItemID + " | " + "Product: " + res[i].product_name + " | " + "Department: " + res[i].department_name + " | " + "price: " + res[i].price + " | " + "QTY: " + res[i].stock_quanity);
    console.log('--------------------------------------------------------------------------------------------------')
  }
